...
const CardCarousel = props => {
  ...
  const [itemsWrapperWidth, setItemsWrapperWidth] = reactExports.useState(null);
  const [currentIndex, setCurrentIndex] = reactExports.useState(0);
  const [transitionIndex, setTransitionIndex] = reactExports.useState(0);
  const [itemCount, setItemCount] = reactExports.useState(0);
  let touchStartVal = 0;
  let touchChangeThreshold = 100;
  const carouselItemsRef = reactExports.useRef();
  const carouselWrapperRef = reactExports.useRef();
