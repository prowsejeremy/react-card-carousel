...
const CardCarouselExample = () => {
  ...
  return (
    <div className="my-inline-component">
      ...
      <div className="intro">
        <h2>Intro to my content</h2>
        <p>This is the intro, the content is to the right of this description and sits in a carousel component. As you resize the page this carousel should move beneath me and add arrows / pagination as needed.</p>
      </div>
